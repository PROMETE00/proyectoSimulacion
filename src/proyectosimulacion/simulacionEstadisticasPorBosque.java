 ...
 * @author prome
 */
public class simulacionEstadisticasPorBosque extends javax.swing.JFrame {
    ...
    public simulacionEstadisticasPorBosque() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new simulacionEstadisticasPorBosque().setVisible(true);
            }
        });
    }
