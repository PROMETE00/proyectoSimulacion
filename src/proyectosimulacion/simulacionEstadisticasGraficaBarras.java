 ...
 * @author prome
 */
public class simulacionEstadisticasGraficaBarras extends javax.swing.JFrame {
    ...
    public simulacionEstadisticasGraficaBarras() {
        initComponents();
    ...
    public void titulo (){
    lblTitulo.setText("         GRAFICA DE BARRAS");
   ...
   public void ecorregion() {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new simulacionEstadisticasGraficaBarras().setVisible(true);
            }
        });
    }
